-- =====================================================
-- SETUP USER ROLES AND FIX AUTHENTICATION ISSUES (FINAL FIXED)
-- =====================================================
...
-- =====================================================
-- STEP 5: CREATE SAMPLE BOOKINGS (ONLY IF USER IS AUTHENTICATED)
-- =====================================================
-- First, let's ensure we only proceed if user is authenticated
DO $$
BEGIN
    ...
    IF auth.uid() IS NOT NULL THEN
        ...
        -- Insert sample payments (only after bookings are created)
        ...
        -- Insert sample tickets (only after bookings are created)
