-- ============================================================================
-- FIX DATABASE SCHEMA - Add missing columns that are causing display issues
-- ============================================================================
...
-- 3.5. Check what columns exist in payment_sessions table
SELECT 
...
-- 4. Update existing transaction details with data from payment sessions
-- First check if the required columns exist in payment_sessions
DO $$
BEGIN
...
-- 5. Update transaction details with HDFC response data
UPDATE transaction_details 
SET 
...
-- 7. Show all transaction details now
SELECT 
