...
import { ArrowLeft, Calendar, MapPin, Users, IndianRupee, Share2, Heart, Clock, Ticket, Globe, Edit, Trash2, Settings } from 'lucide-react'
...
async function getSuggestedEvents(currentEventId: string, category: string) {
  const supabase = await createClient()
...
export default async function EventDetailPage({ 
  ...
  const suggestedEvents = await getSuggestedEvents(event.id, event.category)
